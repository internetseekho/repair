					...
					foreach($recently_ordered_data_list as $recently_ordered_data) {
						...
						<article class="portfolio-item pf-media pf-icons">
							...
							<div class="portfolio-desc">
								<h3><a href="<?=SITE_URL.$model_details_page_slug.$recently_ordered_data['sef_url']?>"><?=$recently_ordered_data['device_title'].$models_text?></a></h3>
								<span><?=$recently_ordered_data['title']?></span>
							</div>
						</article>
					<?php
					} ?>
