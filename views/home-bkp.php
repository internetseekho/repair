...
<div class="models p-5">
  ...
  <div class="col-xs-12 col-sm-12 col-md-12">
    <div class="carousel carousel-showmanymoveone slide carousel-third3" id="itemslider3">
      ...
      <div class="slider-control">
      <a class="left carousel-control" href="#itemslider3" data-slide="prev"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="w-10 h-10 text-primary"><path fill-rule="evenodd" d="M12.79 5.23a.75.75 0 01-.02 1.06L8.832 10l3.938 3.71a.75.75 0 11-1.04 1.08l-4.5-4.25a.75.75 0 010-1.08l4.5-4.25a.75.75 0 011.06.02z" clip-rule="evenodd"></path></svg></a>
      <a class="right carousel-control" href="#itemslider3" data-slide="next"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="w-10 h-10 text-primary"><path fill-rule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clip-rule="evenodd"></path></svg></a>
    </div>
    </div>
  </div>
</div>
...
<div class="app">
	<div class="row">
		<div class="col-md-8">
			...
			<p class="text-white">Sell your old phone | Buy top-quality refurbished phones | Get your phone repaired</p>
			<div class="applog">
        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-8">
                <div class="block newsletter">
                    ...
                    <p>Enroll for the software updates to receive intime communication about the new features that will
...
$('#itemslider3').carousel({ interval: 3000 });
    ...
    $('.carousel-third3 .item').each(function(){
        var itemToClone = $(this);
