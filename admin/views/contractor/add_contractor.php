	...
	<div class="m-grid__item m-grid__item--fluid m-wrapper">
		...
		<div class="m-subheader ">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="m-subheader__title m-subheader__title--separator">Add Contractor</h3>
					<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
						...
						<li class="m-nav__item">
							<a href="" class="m-nav__link">
								<span class="m-nav__link-text">Add Contractor</span>
							</a>
						</li>
					</ul>
				</div>
							...
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-lg-4">
										...
										<input type="text" class="form-control m-input m-input--square" id="company_name" name="company_name">
									</div>
								...
								<div class="form-group m-form__group row">
									<div class="col-lg-3">
										...
										<input type="text" class="form-control m-input m-input--square" id="country" name="country">
									</div>
									...
									<div class="col-lg-3">
										...
										<input type="text" class="form-control m-input m-input--square" id="zip_code" name="zip_code">
									</div>
								</div>
