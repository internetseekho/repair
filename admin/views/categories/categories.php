			...
			<div class="m-portlet m-portlet--mobile">
				<div class="m-portlet__head">
					...
					<div class="m-portlet__head-tools">
						...
						<a title="Add New Category" href="edit_category.php" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill m--margin-right-10">
							<span>
					...
					<div class="m-form m-form--label-align-right m--margin-top-10 m--margin-bottom-10">
						<div class="row align-items-center">
							...
							<!-- <div class="col-xl-4 order-1 order-xl-2 m--align-right"> -->
								<?php
								/*if($prms_category_add == '1') { ?>
								<a href="edit_category.php" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
									<span>
										<i class="la la-plus"></i>
										<span>Add New</span>
									</span>
