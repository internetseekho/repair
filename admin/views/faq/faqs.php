					...
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							<h3 class="m-portlet__head-text">
								Faq List<small></small>
							</h3>
						</div>
					</div>
					<div class="m-portlet__head-tools">
						<a title="Add Faq" href="edit_faq.php" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill m--margin-right-10">
							<span>
					...
					<div class="m-form m-form--label-align-right m--margin-top-10 m--margin-bottom-10">
						<div class="row align-items-center">
							...
							<div class="col-xl-4 order-1 order-xl-2 m--align-right">
								<?php /*?><a href="edit_faq.php" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
									<span>
										<i class="la la-plus"></i>
										<span>Add New</span>
									</span>
