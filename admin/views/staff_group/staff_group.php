	...
	<div class="m-grid__item m-grid__item--fluid m-wrapper">
		...
		<div class="m-subheader ">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="m-subheader__title m-subheader__title--separator">Staff Groups</h3>
					<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
						...
						<li class="m-nav__item">
							<a href="" class="m-nav__link">
								<span class="m-nav__link-text">Staff Groups</span>
							</a>
						</li>
					</ul>
				</div>
					...
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							<h3 class="m-portlet__head-text">
								Staff Group List<small></small>
							</h3>
						</div>
					</div>
					<div class="m-portlet__head-tools">
						<a title="Add Staff Group" href="edit_staff_group.php" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill m--margin-right-10">
							<span>
					...
					<div class="m-form m-form--label-align-right m--margin-top-10 m--margin-bottom-10">
						<div class="row align-items-center">
							...
							<!-- <div class="col-xl-4 order-1 order-xl-2 m--align-right"> -->
								<?php /*?><a href="edit_staff_group.php" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
									<span>
										<i class="la la-plus"></i>
										<span>Add New</span>
									</span>
