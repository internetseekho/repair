			...
			<div class="m-portlet m-portlet--mobile">
				<div class="m-portlet__head">
					...
					<div class="m-portlet__head-tools">
						<?php
						if($prms_page_add == '1' && $p_type == "custom") { ?>
						<a title="Add Page" href="edit_page.php?p_type=<?=$p_type?>" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill m--margin-right-10">
							<span>
					...
					<div class="m-form m-form--label-align-right m--margin-top-10 m--margin-bottom-10">
						<div class="row align-items-center">
							...
							<div class="col-xl-4 order-1 order-xl-2 m--align-right">
								<?php
								/*if($prms_page_add == '1' && $p_type == "custom") { ?>
								<a href="edit_page.php?p_type=<?=$p_type?>" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
									<span>
										<i class="la la-plus"></i>
										<span>Add New</span>
									</span>
