...
function removeRecord(id) {
	swal({
		...
		if(e.value) {
			window.location.href = "controllers/bulk_order.php?d_id="+id;
		}
	});
}
...
function ajax_records_action(ids, type) {
	...
	$.ajax({
		url: "ajax/actions/bulk_order.php",
		method: "POST",
		data: data,
...
function removeImage(id, r_img_id) {
	swal({
		...
		if(e.value) {
			window.location.href = "controllers/bulk_order.php?id="+id+"&r_img_id="+r_img_id;
		}
	});
}
